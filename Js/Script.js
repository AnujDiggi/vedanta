...
function renderUploadedFiles() {
    ...
    uploadedFiles.forEach((file, index) => {
        ...
        filePreview.width = '177.2'; 
        filePreview.height = '164.55'; 
        ...
        fileCheckbox.dataset.fileIndex = index; // Assign index to checkbox for tracking
...
fileInput.addEventListener('change', function (event) {
    ...
    if (file) {
        ...
        if (file.type === 'application/pdf' && file.size <= 5 * 1024 * 1024) {
            ...
            renderUploadedFiles(); // Re-render the uploaded files
            dropFileContainer.style.display = 'none'; // Hide the main upload container
            dropFilePage2.style.display = 'block'; // Show the secondary upload container
...
deleteButton.addEventListener('click', function () {
    ...
    if (uploadedFiles.length === 0) {
        ...
        dropFilePage2.style.display = 'none'; // Hide secondary upload container
        dropFileContainer.style.display = 'block'; // Show main upload container
